...
make_helper(concat(ja_rel_, SUFFIX)) {
		...
		if (cpu.CF == 0 &&  cpu.ZF == 0)return DATA_BYTE + 1;
		else return rel + 1;
}
...
make_helper(concat(jae_rel_, SUFFIX)) {
		...
		if (cpu.CF == 0)return DATA_BYTE + 1;
		else return rel + 1;
}
...
make_helper(concat(jb_rel_, SUFFIX)) {
		...
		if (cpu.CF == 1)return DATA_BYTE + 1;
		else return rel + 1;
}
...
make_helper(concat(jbe_rel_, SUFFIX)) {
		...
		if (cpu.CF == 1 ||  cpu.ZF == 1)return DATA_BYTE + 1;
		else return rel + 1;
}
...
//		printf("%d\n",cpu.ZF);
		if (cpu.ZF == 0)return DATA_BYTE + 1;
		else return rel + 1;
}
...
make_helper(concat(jg_rel_, SUFFIX)) {
		...
		if (cpu.ZF == 0 && cpu.SF == cpu.OF)return DATA_BYTE + 1;
		else return rel + 1;
}
...
make_helper(concat(jge_rel_, SUFFIX)) {
		...
		if (cpu.SF == cpu.OF)return DATA_BYTE + 1;
		else return rel + 1;
}
...
make_helper(concat(jle_rel_, SUFFIX)) {
		...
		if (cpu.ZF == 1 || cpu.SF != cpu.OF)return DATA_BYTE + 1;
		else return rel + 1;
}
...
make_helper(concat(jno_rel_, SUFFIX)) {
		...
		if (cpu.OF == 0)return DATA_BYTE + 1;
		else return rel + 1;
}
...
make_helper(concat(jnp_rel_, SUFFIX)) {
		...
		if (cpu.PF == 0)return DATA_BYTE + 1;
		else return rel + 1;
}
...
make_helper(concat(jns_rel_, SUFFIX)) {
		...
		if (cpu.SF == 0)return DATA_BYTE + 1;
		else return rel + 1;
}
...
make_helper(concat(jo_rel_, SUFFIX)) {
		...
		if (cpu.OF == 1)return DATA_BYTE + 1;
		else return rel + 1;
}
...
make_helper(concat(jp_rel_, SUFFIX)) {
		...
		if (cpu.PF == 1)return DATA_BYTE + 1;
		else return rel + 1;
}
...
make_helper(concat(js_rel_, SUFFIX)) {
		...
		if (cpu.SF == 1)return DATA_BYTE + 1;
		else return rel + 1;
}
